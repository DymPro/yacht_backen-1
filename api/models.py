...
class DepartmentalFormData(models.Model):
    ...
    data = models.JSONField(null=True, blank=True)
    report_number = models.CharField(max_length=256, null=True, blank=True)
    signature = models.ImageField(upload_to='image/', blank=True, null=True)
    to_hod = models.BooleanField(default=False)
    to_ohse_manager = models.BooleanField(default=False)
